				...
				<div class="container">
					<div class="row">
						<div class="col-sm-4 text-center">
							<div class="col-icon"><img src="{{asset('/theme/images/doshas.png')}}" alt="" /></div>
						...
						<div class="col-sm-4 text-center">
							<div class="col-icon"><img src="{{asset('/theme/images/gluten-allergy.png')}}" alt="" /></div>
						...
						<div class="col-sm-4 text-center">
							<div class="col-icon"><img src="{{asset('/theme/images/diet.png')}}" alt="" /></div>
       		...
       		<div class="row">
       			<div class="col-xs-6 col-sm-4">
	    			<div class="itemBox bdr">
	    				<div class="prod"><img src="{{asset('/theme/images/1.jpg')}}" alt="" /></div>
	    		...
	    		<div class="col-xs-6 col-sm-4">
	    			<div class="itemBox bdr">
	    				<div class="prod"><img src="{{asset('/theme/images/2.jpg')}}" alt="" /></div>
	    		...
	    		<div class="col-xs-6 col-sm-4">
	    			<div class="itemBox bdr">
	    				<div class="prod"><img src="{{asset('/theme/images/3.jpg')}}" alt="" /></div>
